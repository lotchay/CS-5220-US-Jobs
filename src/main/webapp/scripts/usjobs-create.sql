...
drop table if exists jobs_applied cascade;
...
INSERT INTO job_postings(
	job_id, date_closed, date_posted, job_description, job_title, location, contact_email, contact_first_name, contact_title, contact_last_name, contact_phone, salary, website, employer_id)
